...
<body>
	...
	<div class="row full-height align-items-center">
		...
		<!-- LEFT NAVBAR -->
		<div
			class="col-sm-2 mr-5 bg-light full-height justify-content-center align-items-center">
			...
			<ul
				...
				<li class="nav-item"><a class="nav-link active" href="Query2"
					data-toggle="tooltip" data-placement="right"
					title="List entity and the ads they pay for"> Ads by Entity </a></li>
				...
				<li class="nav-item"><a class="nav-link active" href="Query4"
					data-toggle="tooltip" data-placement="right"
					title="List companies and their target audience"> Target
						Audience </a></li>
				...
				<li class="nav-item"><a class="nav-link active" href="Query7"
					data-toggle="tooltip" data-placement="right"
					title="List all ads within a date range"> Date Range </a></li>
