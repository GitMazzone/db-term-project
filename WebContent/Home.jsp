...
<body>
	...
	<div class="row full-height">
		...
		<!-- MAIN CONTENT -->
		<div class="col-sm-10 d-flex justify-content-center align-items-center full-height bg-dark text-light">
			<h1 id="content-placeholder">Query results will be shown here!</h1>
		</div>
