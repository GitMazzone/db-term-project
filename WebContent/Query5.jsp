	...
	<div class="row full-height align-items-center">
		...
		<div class="col-sm-8 ml-5 results-content">
			<h3 class="text-center text-light">
				This query displays the proportion (in percent) of all impressions each entity 
				received.
			</h3>
			<table class="table table-striped table-hover">
				<thead class="thead-light">
					<tr>
						...
						<th class="fixed-th">Proportion of All Impressions (in %)</th>
					</tr>
				</thead>
				<c:forEach items="${ result_tuples }" var="item">
					<tr>
						<td class="text-light">${ item.getAdvertiserName() }</td>
						<td class="text-light">${ item.getProportionOfImpressions() }</td>
					</tr>
				</c:forEach>
			</table>
		</div>
